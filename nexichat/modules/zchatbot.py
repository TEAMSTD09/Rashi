...
async def chatbot_response(client: Client, message: Message):
    ...
    try:
        ...
        "- Bas latest message ka relevant aur ekdam shortcut jawab do (halka jiddipan, nautanki, gussa, emotional... all type feeling bhi situation ke hisab se hona chahiye) aur pichle topic aur new msg ke anusar new reply hona chahiye.\n"
